...
function dot() { inputBox.value += '.'; }

function zero() { inputBox.value += 0; }

function one() { inputBox.value += 1; }

function two() { inputBox.value += 2; }

function three() { inputBox.value += 3; }

function four() { inputBox.value += 4; }

function five() { inputBox.value += 5; }

function six() { inputBox.value += 6; }

function seven() { inputBox.value += 7; }

function eight() { inputBox.value += 8; }

function nine() { inputBox.value += 9; }
...
function multiple(num1, num2) { return num1 * num2; }
